...
/// <summary>
/// Class for an apartment. Defines additional attributes of a residential property
/// that is of type apartment. 
/// </summary>
namespace RealEstateInventory
{
    public class Apartment : ResidentialProperty
    {
        public const double FLOOR_MULTIPLIER = 0.5;
        ...
        /// <param name="floor">The floor number the apartment sits on</param>
        public Apartment(string address, int yearBuilt, int squareFeet, List<Addition> amenities,
            int floor) : base(address, yearBuilt, squareFeet, amenities)
        {
            _floor = floor;
        }

        /// <summary>
        /// Property for floor variable.
        /// </summary>
        public int Floor
        {
            get { return _floor; }
        ...
        public override double CalculateCost()
        {
            ...
            double floorBonus = basePrice * ((Floor * Apartment.FLOOR_MULTIPLIER) / 100);
        ...
        {
            return "Apartment at " + Address + " built in " + YearBuilt + " with " + String.Format("{0:n0}", SquareFeet) +
