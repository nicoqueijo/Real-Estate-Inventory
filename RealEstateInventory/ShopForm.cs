...
/// <summary>
/// Form to add a shop to the database.
/// </summary>
namespace RealEstateInventory
{
    public partial class ShopForm : Form
    {
        ...
        private void addShopButton_Click(object sender, EventArgs e)
        {
            ...
            {
                _propertyType = CommercialProperty.Type.Retail;
                _parkingLot = parkingLotYesRadioButton.Checked;
                shop = new Shop(_address, _yearBuilt, _squareFeet, _propertyType, _parkingLot);
